...
RSpec.feature 'CheckOut_address', :type => :feature do
  ...
  describe 'login user and clicks the Checkout button' do
    ...
    it 'his order (not empty cart) valid address' do
      ...
      fill_in 'setting_address[billing_address][first_name]', with: 'first_name'
      fill_in 'setting_address[billing_address][last_name]', with: 'last_name'
      ...
      fill_in 'setting_address[shipping_address][first_name]', with: 'first_name'
      fill_in 'setting_address[shipping_address][last_name]', with: 'last_name'
